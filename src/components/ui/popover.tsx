...
const PopoverContent = ({
  ...
  return (
    <PopoverPrimitive
      ...
      offset={offset}
      className={cx(
        'group/popover bg-overlay text-overlay-fg max-w-xs min-w-(--trigger-width) origin-(--trigger-anchor-point) rounded-xl border shadow-xs outline-hidden transition-transform [--gutter:--spacing(6)] sm:text-sm dark:backdrop-saturate-200 **:[[role=dialog]]:[--gutter:--spacing(4)]',
