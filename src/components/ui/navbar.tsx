...
import { Button, type ButtonProps, composeTailwindRenderProps, Sheet } from 'ui'
...
const navStyles = tv({
  ...
  variants: {
    ...
    intent: {
      ...
      navbar: 'bg-navbar text-navbar-fg md:px-6',
      inset: [
        'mx-auto md:px-6',
    ...
    return (
      <Sheet isOpen={open} onOpenChange={setOpen} {...props}>
        <Sheet.Content
          ...
          data-navbar='compact'
          classNames={{
            content: 'text-fg font-semibold [&>button]:hidden',
