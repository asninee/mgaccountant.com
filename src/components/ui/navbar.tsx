    ...
    >
      <div
        className={twMerge(
          ...
          intent === 'default' && 'bg-navbar',
          className
        )}
      >
        <div
          data-navbar='content'
          className='mx-auto h-14 w-full max-w-7xl items-center py-2.5 md:flex'
        >
          {children}
        </div>
      </div>
    ...
    <Link
      ...
      className={cx(
        [
          ...
          'text-left font-semibold disabled:cursor-default disabled:opacity-50',
        ],
        className
      )}
      {...props}
